...
if ($id && $produit && $table) {
    ...
    if ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
        ...
        do {
            ?>
            <div class='card'>
                <img src='/images/servicesetproduits/<?= $row['image_url'] ?>' alt='<?= $row['alt_text'] ?>'>
                <h3><?= $row['titre'] ?></h3>
                ...
                if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true) {
                    ?>
                    <div class='admin'>
                        <a href='/src/pages/admin/modifier.php?id=<?= $row['id'] ?>' class='admin_action_special'>
                        ...
                        <a href='supprimer.php?id=<?= $row['id'] ?>' class='admin_action_special'>
    ...
    // Gérer le cas où les paramètres ne sont pas fournis
