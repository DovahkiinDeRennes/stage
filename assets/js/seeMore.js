$(document).ready(function() {
    ...
    function truncateText() {
        $(".text-content").each(function() {
            ...
            if (html.length > 100) { // Assurez-vous que le texte a plus de 100 mots
                var truncatedHtml = html.slice(0, 20).join(" ") + '<span class="dots">...</span><span class="full-text"> ' + html.slice(20).join(" ") + '</span>';
