    ...
    <nav>
          ...
          <a class="link" href="contact.php"><p class="link">Contact</p></a>
            ...
            <div id="mySidenav" class="sidenav">
                ...
                <ul>
                    <li><a class="link" href="/src/fideliliumAdmin/admin/index.php">
                            <p class="link" id="page-actuel">Admin</p>
                        </a>
                    <li><a class="link" href="/src/fideliliumAdmin/admin/mail/mail.php">
                            <p class="link">Mails</p>
                        </a></li>
                    <li><a class="link" href="/src/fideliliumAdmin/admin/services/services.php">
                            <p class="link">Services</p>
                        </a></li>
                    <li><a class="link" href="/src/fideliliumAdmin/admin/produits/produits.php">
                            <p class="link">Produits</p>
                        </a></li>
                    <li><a class="link" href="/src/fideliliumAdmin/admin/actualites/actualites_creation.php">
                            <p class="link">Actualités</p>
                             </a></li>
                                                                                   
                             <li><a class="link" href="/src/fideliliumAdmin/admin/categories/categories.php">
                             <p class="link">Categories</p>
                             </a></li>
                        </a></li>
                    <li><a class="link" href="/src/fideliliumAdmin/admin/logout.php">
        ...
        <div class="navbar">
            <nav>
                <a href="/index.php" data-aos="fade-right" data-aos-duration="1000"><img
                        srcset="/images/Fifelilium_Logo_Solo_RVB.svg" style="width: 120px;"></a>
                <div class="onglets" data-aos="fade-left" data-aos-duration="1000">
                    <a class="link" href="/src/fideliliumAdmin/admin/index.php">
                        <p class="link" id="page-actuel">Admin</p>
                    </a>
                    <a class="link" href="/src/fideliliumAdmin/admin/mail/mail.php">
                        <p class="link">Mails</p>
                    </a>
                    <a class="link" href="/src/fideliliumAdmin/admin/services/services.php">
                        <p class="link">Services</p>
                    </a>
                    <a class="link" href="/src/fideliliumAdmin/admin/produits/produits.php">
                        <p class="link">Produits</p>
                    </a>
                    <a class="link" href="/src/fideliliumAdmin/admin/actualites/actualites_creation.php">
                        <p class="link">Actualités</p>
                    </a>
                       <a class="link" href="/src/fideliliumAdmin/admin/categories/categories.php">
                             <p class="link">Categories</p>
                             </a>
                    <a class="link" href="/src/fideliliumAdmin/admin/logout.php">
                        <p class="link">Se deconnecter</p>
                    </a>
                </div>
            </nav>
